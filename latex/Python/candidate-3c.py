...
sim_file   = open('simulation_01.csv') 
...
for loop in range(20):
    ...
    model = MultinomialNB(alpha=0.3).fit(X_train, y_train)
    ...
    out_file_name_01 = 'C:\\Users\\DColton\\Google Drive\\Masters\\MSIT - H6029 - MSc Research Project\\Data\\Corpora\\cyberbullying_01.csv' 
    ...
    out_file_name_02 = 'C:\\Users\\DColton\\Google Drive\\Masters\\MSIT - H6029 - MSc Research Project\\Data\\Corpora\\simulation_03.csv' 
...
out_hb_name = 'C:\\Users\\DColton\\Google Drive\\Masters\\MSIT - H6029 - MSc Research Project\\Data\\Corpora\\hold_back_03.csv' 
